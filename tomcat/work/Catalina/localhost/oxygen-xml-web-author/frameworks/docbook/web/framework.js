...
/**
 * The docbook version. Will be assigned the definitive value once the editor is created.
 */
...
sync.docbook.DocbookExtension.prototype.extendWebLinkAction = function (editor) {
  var insertWebLinkActionId =
    this.version === 5 ? "insert.web.link" : "insert.web.ulink";
  ...
  if(originalInsertWebLinkAction) {
    var webLinkOperationClass = this.version === 5 ?
...
sync.docbook.DocbookExtension.prototype.extendInsertTableAction = function(actionsMap, editingSupport) {
  ...
  var namespace = this.version === 5 ? "http://docbook.org/ns/docbook" : "";
 ...
 */
sync.docbook.DocbookExtension.prototype.getRootNamespace_ = function(editor) {
  var doc = editor.getEditingSupport().getDocument();
...
sync.docbook.DocbookExtension.prototype.editorCreated = function(editor) {
  var rootNamespace = this.getRootNamespace_(editor);
  this.version = !rootNamespace ? 4 : 5;
